...
It is best to upload cleaned data.
<br><br>
Clean data includes:
...
convenient way to upload to rtemislive is to use `saveRD()` to save to an RDS and then
upload that file. This will maintain all column classes.
